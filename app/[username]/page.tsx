  ...
  if (error || !uid) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-2xl font-bold tracking-tight mb-2">User Not Found</h1>
        <p className="text-neutral-500 dark:text-neutral-400 mb-8 max-w-sm">
          We couldn't find a watchlist for "{username}". They might have changed their username or deleted their account.
        </p>
        <Link 
          href="/"
